...
// Preload images
  ...
  return (
    <>
      <div className="min-h-screen bg-orange-50 flex flex-col gap-4 items-center relative">
          ...
          <div className="menu-left flex-1 p-3 bg-primary">
            <div className="heading">
              ...
              <p className="data-time mb-4 text-center">
                Everyday from{" "}
                <span className="text-white">10:00am - 10:00pm</span>
              </p>
            </div>
        ...
        {/* <footer className="bg-black text-white w-full py-2 px-4 flex-grow flex justify-between items-center">
          ...
          <ul className="flex gap-4">
            <li><a className="text-white hover:text-primary transition-colors duration-300" target="_blank" href="https://github.com/thecodemaster12">
